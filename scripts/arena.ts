...
import { attach, deploy, setSupportCollateral, setBattleCreaters} from './utils'
...
async function main() {
	...
	console.log(`use arena ${arena.address.toLowerCase()} deployer ${deployerAddr} usdc ${usdcAddr}`)
	...
	await setBattleCreaters(arena, ["0x466043D6644886468E8E0ff36dfAF0060aEE7d37", "0x22ca9b22095de647c28debc4dea2cb252dfd531a", "0x990A294Bc162e00A4a43488C10B26641b3B174AB"], [true, true, true])
